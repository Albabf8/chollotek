...
public interface ProductoDAO {
     ...
     * Se usa en la funcionalidad de búsqueda avanzada donde el usuario
     * puede combinar varios criterios: nombre, marca y rango de precio.
     *
     ...
     * permitiendo al usuario encontrar productos sin escribir el nombre completo.
     *
     * @param nombre texto a buscar en el nombre del producto (null para ignorar)
     * @param marca texto a buscar en la marca del producto (null para ignorar)
     * @param precioMin precio mínimo del rango (null para no poner límite inferior)
     * @param precioMax precio máximo del rango (null para no poner límite superior)
     ...
     * Se usa para mostrar la ficha detallada de un producto cuando
     * el usuario hace clic en él desde el catálogo o búsqueda.
     *
     ...
     * Se usa cuando el usuario filtra por categoría desde el menú
     * lateral o hace clic en una categoría concreta.
     *
     ...
     * Se usa para mostrar el catálogo completo de productos,
     * ordenados alfabéticamente por nombre para facilitar la navegación.
     *
     * @param con conexión activa a la base de datos
    ...
    /**
     * Obtiene todas las marcas únicas que existen en la tabla productos.
     * Se usa para popular el filtro desplegable de marcas en el buscador,
     * mostrando solo las marcas que tienen al menos un producto.
     *
     * Las marcas se devuelven ordenadas alfabéticamente y sin duplicados.
     *
     * @param con conexión activa a la base de datos
     * @return lista de strings con los nombres únicos de marcas (vacía si no hay productos)
     * @throws Exception si hay error en la consulta SQL o problemas de conexión
     */
    List<String> obtenerMarcas(Connection con) throws Exception;

    /**
     * Obtiene el precio máximo entre todos los productos de la tienda.
     * Se usa para establecer el límite superior del slider de filtro de precio
     * en la búsqueda, ajustándose dinámicamente al catálogo real.
     *
     * @param con conexión activa a la base de datos
     ...
     * Se usa para mostrar productos destacados en la página principal (landing page)
     * o secciones de "productos recomendados", manteniendo variedad en cada visita.
     *
     * Usa la función RAND() de MySQL para aleatorización, limitando
     * el resultado a la cantidad solicitada.
     *
     * @param cantidad número de productos aleatorios a obtener (típicamente 8 para landing)
     * @param con conexión activa a la base de datos
     * @return lista de productos aleatorios (puede tener menos elementos si no hay suficientes productos)
     * @throws Exception si hay error en la consulta SQL o problemas de conexión
     */
