...
public interface CategoriaDAO {
     ...
     * filtrada por categoría, o para validar que existe antes de filtrar
     * productos.
     *
     ...
     *
     * Se usa principalmente en el AppListener al arrancar la aplicación para
     * cargarlas en el atributo de contexto "categorias", haciendo que estén
     * disponibles para todas las JSPs sin necesidad de consultarlas
     * repetidamente desde la base de datos.
     *
     * Las categorías se devuelven ordenadas alfabéticamente por nombre para
     * mantener un orden consistente en los menús de navegación.
     *
     * @param con conexión activa a la base de datos
     * @return lista de todas las categorías (vacía si no hay categorías
     * configuradas)
     * @throws Exception si hay error en la consulta SQL o problemas de conexión
     */
