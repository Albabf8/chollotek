    ...
    <body>
        ...
        <div class="container">
            ...
            <aside class="sidebar">
                ...
                <!-- FILTROS AVANZADOS -->
                <!-- Guardamos los precios como strings limpios para usarlos en los inputs -->
                <fmt:formatNumber var="precioMinStr" value="${precioMinGlobal}" pattern="#.00"/>
                <fmt:formatNumber var="precioMaxStr" value="${precioMaxGlobal}" pattern="#.00"/>
                ...
                <form action="FrontController" method="post" class="filtros">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="precioMin"
                               step="0.01"
                               min="${precioMinStr}" max="${precioMaxStr}"
                               value="${not empty precioMinSeleccionado ? precioMinSeleccionado : precioMinStr}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="precioMax"
                               step="0.01"
                               min="${precioMinStr}" max="${precioMaxStr}"
                               value="${not empty precioMaxSeleccionado ? precioMaxSeleccionado : precioMaxStr}">
                    </div>
