            ...
            <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
                ...
                <body>
                    ...
                    <div class="container">
                        <nav class="breadcrumb">
                            ...
                            <c:if test="${not empty categoria}">
                                <a
                                    href="${pageContext.request.contextPath}/FrontController?accion=filtrar&idCategoria=${categoria.idcategoria}">
                                    ${categoria.nombre}
                                </a>
                                <span class="separator">›</span>
                            </c:if>
                    ...
                    <div class="container">
                        <div class="detalle-producto">
                            ...
                            <div class="detalle-info">
                                ...
                                <!-- AÑADIR AL CARRITO -->
                                <form onsubmit="anadirCarritoAjaxDetalle(event, '${producto.idproducto}')"
                    ...
                    <script>
                        ...
                        function anadirCarritoAjaxDetalle(event, idProducto) {
                            event.preventDefault();

                            var cantidad = parseInt(document.getElementById('cantidad').value) || 1;

                            // Realizar una petición por cada cantidad ya que el backend suma 1 a 1 en 'anadir'
                            // Podríamos optimizarlo en backend pero esta es una solución rápida y compatible
                            var promises = [];
                            ...
                            Promise.all(promises).then(function (results) {
                                ...
                                var exitos = results.filter(function (r) { return r.exito; }).length;
                                if (exitos === cantidad) {
                                    mostrarToast("🛒 Se han añadido " + cantidad + " unidades al carrito", "success");
                                } else {
                                    mostrarToast("❌ Hubo un error al añadir alguna unidad", "error");
                                }
